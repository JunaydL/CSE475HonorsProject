...
data_train, data_test, t_train, t_test = train_test_split(data, targets, train_size=0.75, test_size=0.25, random_state=0)
...
for i, x in enumerate(model_list):
    ...
    plt.savefig("./75_25_DecisionTrees/75_25_Trial" + str(i + 1) + ".png")
