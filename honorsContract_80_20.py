...
data_train, data_test, t_train, t_test = train_test_split(data, targets, train_size=0.80, test_size=0.20, random_state=0)
...
for i, x in enumerate(model_list):
    ...
    plt.savefig("./80_20_DecisionTrees/80_20_Trial" + str(i + 1) + ".png")
